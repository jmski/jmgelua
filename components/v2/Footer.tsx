...
const Footer = () => (
  <div className="flex flex-col justify-center items-center bg-footer py-16 px-8 sm:p-16 md:py-16 md:px-24">
    <div className="w-full text-center mb-12">
      <h1 className="text-blue-200 text-4xl leading-10 sm:text-5xl sm:leading-12 md:text-6xl md:leading-18 font-extrabold">
        ...
        <span className="px-4 bg-gradient-to-r from-blue-500 to-cyan-500 bg-growing-underline hover:text-white">
          <a href="mailto:geluajm@gmail.com">Let's work together</a>
        </span>
      </h1>
    </div>

    <div className="text-white flex justify-center items-center p-4 border border-white text-center mb-10 cursor-pointer">
      <p className=" text-sm sm:text-lg leading-5">
        <a>Connect with me</a>
      </p>
    </div>

    <div className="text-white flex justify-between items-start flex-row flex-wrap w-100 text-left">
      ...
      <div className="flex flex-start flex-col my-4 sm:m-4">
        <h4 className=" text-sm leading-4 mb-4">Links</h4>
      ...
      <div className="flex flex-start flex-col my-4 sm:m-4">
        <h4 className=" text-sm leading-4 mb-4">Social</h4>
        <p className="text-xs my-2 mx-0 cursor-pointer">
        ...
        <p className="text-xs my-2 mx-0 cursor-pointer">
          <a href="/JonMichaelGeluaResume2021.pdf" target="_blank">
            Resume
          </a>
        </p>
      </div>
      <div className="flex flex-start flex-col my-4 sm:m-4">
        <h4 className=" text-sm leading-4 mb-4">Jon-Michael Gelua</h4>
    ...
    <div className="mt-8 text-center w-full my-4 sm:m-4">
      <p className="text-xs text-white">@2021 JM-6. All rights reserved.</p>
    </div>
  </div>
);
